...
def main(mode, debug, dry):
    ...
    variant=dict(
            ...
            env_id='SawyerPushHurdleMiddle-v0',    
            skewfit_variant=dict(
                vae_path=None, # can change to pre-trained params.pkl
                # vae_path='data/local/pre-trained-models/puck-push-hurdle-bottom/', 
    ...
    exp_prefix = '10-21-ROLL-hurdle-bottom-release'
